...
export function WhatsAppButton() {
  const message = encodeURIComponent(
    "Hi Dreamz Dezignerz! I'm interested in your services. Can we discuss my project?"
  );
  ...
  return (
    ...
    >
      ...
      <span className="absolute -right-1 -top-1 h-4 w-4 animate-ping rounded-full bg-orange" />
      <span className="absolute -right-1 -top-1 h-4 w-4 rounded-full bg-orange" />
    </motion.a>
  );
}
